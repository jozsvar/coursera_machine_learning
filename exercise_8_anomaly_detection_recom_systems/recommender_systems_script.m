%%%% RECOMMENDER SYSTEMS - SCRIPT %%%%

% Load data set (Y and R loaded into the environment)
...
% Compute statistics, like average rating, from the matric.
...
% After the additional ratings have been added to the dataset, the code below will proceed to train the collaborative filtering model
...
% The code below computes the ratings for all the movies and users and displays the movies that it recommends, according to ratings that were entered earlier in the script. 
p = X * Theta';
